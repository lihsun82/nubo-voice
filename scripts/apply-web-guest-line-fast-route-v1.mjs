...
const marker = 'NUBO_GUEST_LINE_FAST_ROUTE_V3_COMPLAINT_GATED';
...
console.log('Applied deterministic guest-service LINE fast route v3 (complaints gated)');
