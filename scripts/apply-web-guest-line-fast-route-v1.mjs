...
const marker = 'NUBO_GUEST_LINE_FAST_ROUTE_V4_COMPLAINT_SESSION_GATED';
...
console.log('Applied deterministic guest-service LINE fast route v4 (complaint sessions gated)');
